...
class Drama extends PC_Controller {

	function __construct() {
		parent::__construct();
		$this->API="https://api.gdriveplayer.us/v1/drama";
		$this->controller="drama";
	...
	public function detail($id = NULL, $eps = 1)
	{
		...
		$data['eps'] = $eps;
		$data['type'] = "drama";
		$data['main'] = json_decode($this->curl->simple_get('https://api.gdriveplayer.us/v1/drama/id/'.$id), TRUE);
